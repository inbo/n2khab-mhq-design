...
streams_segments_all <- vha_segments_combined %>%
  ...
  dplyr::select(segment_id = sampling_unit_code, river_name = name, wl_code, x, y, grts_ranking) 
...
streams_segments_all %>%
  write_vc(root =  "../output", file = "streams_segments", sorting = c("segment_id", "grts_ranking", "river_name"), strict = FALSE)
