...
map_3260_v1_6 <- read_habitatstreams()
...
st_crs(segments_3260_final) <- 31370
...
write_vc(habitatmap_streams_segments, file = "sample_frame_habitatstreams_v1_4", root = "../output", sorting = "segment_id")
