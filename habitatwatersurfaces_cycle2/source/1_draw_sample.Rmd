...
watersurfaces_populationunits <- read_vc(root = file.path(data_path, "output"), file = "mhq_watersurfaces_populationunits")
...
sample_final_wide_sf %>%
  st_write("../output/mhq_standingwater_cycle2.gpkg", delete_dsn = TRUE)
```
