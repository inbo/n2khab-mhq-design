...
We used version 1.4 of habitatstreams as the sample frame. This version is not yet avaialable on Zenodo. The file 'BasisbestandSteekproeftrekkingHT3260' (see [this google drive folder](https://drive.google.com/drive/folders/1i2cNnU3eJo4lbVeI23FGtv-6ljOV7M3L)) contains the sample frame and also information on the different strata which are part of the design:
