...
This approach is not perfect, so we add an extra restrictions: we exclude points that are located in the old habitatmap (v1.4) as it is quite unlikely that these points are suited.
...
st_write(sample_frame_3260, "../output/sample_frame_streams.gpkg", "sample_frame_habitatstreams_v1_7", driver = "GPKG", append = TRUE)
