...
segments_3260_new <- segments_3260_new_extra %>%
  ...
  dplyr::select(segment_code = id, wl_code, wl_code_old, grts_ranking, sac, catchment_area)

st_write(segments_3260_new, "../output/segments_3260_v18", "segments_3260_new_v18", driver = "ESRI Shapefile", append  = TRUE)
