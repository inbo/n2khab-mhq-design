...
st_write(segments_3260_new_addgrts, "../output/segments_3260_v18_2.gpkg", "segments_3260_v18_2", driver = "GPKG", append = TRUE)
...
write_vc(sample_frame_3260, root =  "../output", file = "sample_frame_3260_v18", sorting = c("sampling_unit_code", "grts_ranking", "river_name"), strict = FALSE)
```
